...
//			String query = "INSERT INTO MEMBER_TBL VALUES ('"+member.getMemberId()+"', '"+member.getMemberPw()+"', '"+member.getMemberName()+"','"+member.getGender()+"', "+member.getAge()+", '"+member.getEmail()+"', '"+member.getPhone()+"', '"+member.getAddress()+"', '"+member.getHobby()+"', DEFAULT)";
...
//			String query = "SELECT * FROM MEMBER_TBL WHERE MEMBER_ID = '"+member.getMemberId()+"' AND MEMBER_PW = '"+member.getMemberPw()+"'";
	...
	private Member rsetToMember(ResultSet rset) throws SQLException { //던져서 호출한곳에서 처리하는거 호출한곳 SelectOne
